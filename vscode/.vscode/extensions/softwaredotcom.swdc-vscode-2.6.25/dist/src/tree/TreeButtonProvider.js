...
function getViewProjectSummaryButton() {
    ...
    const item = getActionButton(commitSummitLabel, '', 'codetime.viewProjectReports', 'folder.svg', '', 'red');
...
function getCodeTimeDashboardButton() {
    const item = getActionButton(`Dashboard`, 'View your latest coding metrics right here in your editor', 'codetime.viewDashboard', 'dashboard.svg', 'TreeViewLaunchDashboard', 'purple');
    item.location = 'ct_menu_tree';
...
function getSwitchAccountButtonItem() {
    const item = getActionButton('switch account button', 'Code Time', 'codetime.switchAccount');
